...
class TestNTT:
    ...
    def test_ntt_multiplication(self, ntt_kyber):
        ...
        A = ntt_kyber.ntt(a)
        B = ntt_kyber.ntt(b)
        C = ntt_kyber.ntt_mul(A, B)
        c_ntt = ntt_kyber.intt(C)
...
class TestMeshHandshake:
    ...
    def test_encrypted_communication(self, mesh_alice, mesh_bob):
        ...
        msg = "Hello from quantum-safe mesh!".encode("utf-8")
...
class TestPassportGateway:
    ...
    def test_full_passport(self, passport_gateway):
        ...
        is_human, confidence = passport_gateway.verify_humanity(result, passport_gateway.pk)
        assert is_human
    ...
    def test_insufficient_stamps(self, passport_gateway):
        ...
        is_human, _ = passport_gateway.verify_humanity(result, passport_gateway.pk)
        assert not is_human
